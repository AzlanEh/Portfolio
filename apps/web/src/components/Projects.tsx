const Projects = () => {
  const projects = [
    ...
    {
      title: "Zenith — Digital Sanctuary",
      description:
        "A high-fidelity digital wellbeing platform for reclaiming cognitive sovereignty. Built with Tauri 2 and React 19, it automatically tracks application usage, enforces daily app limits with optional hard blocking, and provides focus sessions, break reminders, and screen time goals — all wrapped in a brutalist monochrome desktop interface.",
      technologies: [
        "React",
        "TypeScript",
        "Rust",
      ...
      githubLink: "https://github.com/AzlanEh/zenith",
      liveLink: "https://github.com/AzlanEh/zenith/releases",
      features: [
        "Automatic window tracking with session detection (Hyprland/Sway/X11/Windows)",
        "App limits with hard blocking and emergency bypass",
        "Scheduled focus sessions with block lists",
        "Pomodoro-style break reminders",
        "Screen time goals, streaks, and achievements",
        "Historical analytics with daily/weekly/category breakdowns",
        "CSV/JSON data export and import",
        "System tray with headless background tracking",
        "Dark/light theme with brutalist monochrome design",
      ],
    },
    // {
    //   title: "Trip List App",
    ...
    // },
    {
      ...
      liveLink: "https://portfolio-web-seven-blue.vercel.app/",
      features: [
